...
question_en <- c(
  ...
  "고통받는 사람들에 대한 연민과 동정이 사람으로서 가장 중요한 덕목이다." = "Compassion and sympathy are the most important human virtues",
  "성공하기 위해서는 다른 사람을 눌러야 할 때도 있다"               = "Success sometimes requires pushing others down",
  "나는 인류의 대부분이 사라지고 소수의 사람들만 남아 새롭게 시작하는 상상을 하곤 한다." = "I imagine most of humanity disappearing",
  ...
  "동성애자나 외국인노동자, 장애인 등 사회적 약자와 소수자를 보호하고자 하는 사람들의 도덕적 우월감에 불편함을 느낀다." = "Advocates for the vulnerable display uncomfortable moral superiority",
  "나는 가끔 좋고 멋진 것들(beautiful things)을 파괴하고 싶은 충동을 느낀다." = "I feel the urge to destroy beautiful things",
  ...
  "명절 연휴에 제사를 안 지내고 해외여행을 가는 것은 비난받을 일이 아니다." = "Going abroad instead of ancestral rites on holidays is acceptable",
  "요즘 우리 사회는 말 한마디에도 너무 민감하게 반응하는 경향이 있다." = "Today's society is too sensitive about language",
  ...
  "결혼은 반드시 해야 하는 것이 아니라 개인의 선택이다."           = "Marriage is a personal choice",
  "우리나라를 망쳐놓고 있는 극단주의를 제압할 수 있는 강력한 지도자가 필요하다" = "We need a strong leader to suppress extremism",
  "우리는 사회 제도의 문제를 해결할 수 없으므로, 이를 완전히 허물고 다시 시작해야 한다." = "Society's institutions should be torn down and rebuilt",
  "부정행위를 저지른 사람이 적발되어 처벌받을 때 기분이 좋다."     = "Punishing wrongdoers feels satisfying",
  ...
  "일도 좋지만 여성이 우선순위를 둬야하는 것은 가정과 아이들이다." = "Women should prioritize family and children",
