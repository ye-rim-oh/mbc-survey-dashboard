...
question_en <- c(
  ...
  "기후위기 극복을 위한 강한 규제가 필요하다"                      = "We need stronger regulations than we currently have to overcome the climate crisis",
  ...
  "사회적 약자 보호 노력이 과하다"                                 = "In our country, efforts to protect minorities and the vulnerable — including LGBTQ individuals, migrant workers, and people with disabilities — have gone too far",
  "성공하려면 타인을 눌러야 할 때도 있다"                          = "Success sometimes requires pushing others down",
  "세상에는 상대적으로 남보다 더 우월한 사람들이 있다"             = "There are people in this world who are, relatively speaking, superior to others",
  "아이를 갖는 것은 사회적 의무다"                                 = "Having children is a social obligation",
  "약자 보호를 주장하는 사람들의 도덕적 우월감이 불편하다"         = "I feel uncomfortable with the moral superiority of those who advocate for minorities and the vulnerable, such as LGBTQ individuals, migrant workers, and people with disabilities",
  "약자나 취약한 위치에 있는 사람을 신경쓰는 것은 중요하다"        = "Caring for the weak and vulnerable is important",
  "약자를 공정하게 대우하는 것이 중요하다"                         = "It is important to protect the vulnerable and treat everyone fairly, even people I don't know",
  ...
  "차별금지법은 도입되어야 한다"                                   = "A law banning discrimination based on sex, disability, medical history, age, religion, and sexual orientation should be enacted",
  ...
  "동성애자나 외국인노동자, 장애인 등 사회적 약자와 소수자를 보호하고자 하는 사람들의 도덕적 우월감에 불편함을 느낀다." = "I feel uncomfortable with the moral superiority of those who advocate for minorities and the vulnerable, such as LGBTQ individuals, migrant workers, and people with disabilities",
  ...
  "약자를 보호하고, 내가 모르는 사람들까지도 공정하게 대우하는 것이 중요하다." = "It is important to protect the vulnerable and treat everyone fairly, even people I don't know",
  "우리나라는 동성애자나 외국인노동자, 장애인 등 사회적 약자와 소수자를 보호하려는 노력이 과하다." = "In our country, efforts to protect minorities and the vulnerable — including LGBTQ individuals, migrant workers, and people with disabilities — have gone too far",
  "기후위기 극복을 위해 지금보다 강한 규제를 시행해야 한다."        = "We need stronger regulations than we currently have to overcome the climate crisis",
  ...
  "성별·장애·병력·나이·종교·성적 지향 등에 대한 차별을 금지하는 차별금지법은 도입돼야 한다." = "A law banning discrimination based on sex, disability, medical history, age, religion, and sexual orientation should be enacted",
